...
camada_enlace_transmissora.o: src/camada_enlace_transmissora.cpp
	$(cc) -g -I include -c src/camada_enlace_transmissora.cpp -o build/camada_enlace_transmissora.o
